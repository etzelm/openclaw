...
export const GATEWAY_SHUTDOWN_RESERVE_SHARE: number;
export const GATEWAY_SUPERVISOR_EXIT_MARGIN_SHARE: number;
export const RESPAWN_SIGNAL_EXIT_GRACE_MS: number;
...
export function resolveRespawnServiceStopTimeoutMs(
